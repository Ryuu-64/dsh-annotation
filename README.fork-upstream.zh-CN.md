...
> **这是 fork**：`@ryuu-64/dsh-annotation`，基于上游
> [`@changfenhuang/dsh-annotation`](https://github.com/omdsh-dev/dsh-annotation) **1.4.10**（MIT）。
> 只改浏览器端悬浮面板（hover tip）子系统，修复「鼠标悬停到批注上只闪一下就消失」。
> 改动清单见 [`NOTICE.md`](./NOTICE.md) 与 [`CHANGELOG.md`](./CHANGELOG.md)。
> **问题请提到本仓库**：https://github.com/Ryuu-64/dsh-annotation/issues
...
<p align="center"><strong>🌐 本 fork 仓库：<a href="https://github.com/Ryuu-64/dsh-annotation">github.com/Ryuu-64/dsh-annotation</a>（上游产品站见 <a href="https://omdsh-dev.github.io/dsh-annotation/">omdsh-dev.github.io/dsh-annotation</a>）</strong></p>
